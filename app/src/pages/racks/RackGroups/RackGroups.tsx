...
export default function RackGroups({
  ...
  return (
    <PageShell
      ...
      subtitle="Consulte e gerencie os agrupamentos de racks do datacenter."
    >
      <label className="organization__search">
        ...
        <input
          ...
          placeholder="Buscar grupo de racks"
        />
      </label>
      {error ? (
      ...
      <section
        ...
        aria-label="Resumo dos grupos de racks"
      >
        <div>
          ...
          return (
            ...
            >
              ...
              <div className="organization__card-content">
                ...
                <small>
                  <span>{item.rack_count} rack(s)</span>
                </small>
              </div>
            </article>
          );
      ...
      {selectedItem ? (
        ...
        >
          ...
          >
            ...
            <div>
              <h2 id="rack-group-details-title">
                Informações do grupo de racks
              </h2>
            ...
            <dl>
              ...
              <div>
                <dt>Slug</dt>
                <dd>{selectedItem.slug || "Não informado"}</dd>
              </div>
              <div>
                <dt>Racks</dt>
