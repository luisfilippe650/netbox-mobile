...
export const devicesApi = {
  ...
  create: (body: unknown) => netboxClient.create(endpoints.devices, body, deviceCreateSchema, deviceSchema),
  update: (id: number, body: unknown) => netboxClient.update(`${endpoints.devices}${id}/`, body, deviceUpdateSchema, deviceSchema),
  delete: (id: number) => deleteResource('devices', id),
}

export const deviceTypesApi = {
  list: () => netboxClient.list(endpoints.deviceTypes, deviceTypeSchema),
  create: (body: unknown) => netboxClient.create(endpoints.deviceTypes, body, deviceTypeCreateSchema, deviceTypeSchema),
...
export const deviceRolesApi = {
  ...
  create: (body: unknown) => netboxClient.create(endpoints.deviceRoles, body, deviceRoleCreateSchema, deviceRoleSchema),
  delete: (id: number) => deleteResource('device-roles', id),
}

export const manufacturersApi = {
  list: () => netboxClient.list(endpoints.manufacturers, manufacturerSchema),
  create: (body: unknown) => netboxClient.create(endpoints.manufacturers, body, manufacturerCreateSchema, manufacturerSchema),
