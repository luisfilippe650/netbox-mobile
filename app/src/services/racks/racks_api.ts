...
export const racksApi = {
  ...
  create: (body: unknown) => netboxClient.create(endpoints.racks, body, rackCreateSchema, rackSchema),
...
export const rackGroupsApi = {
  ...
  create: (body: unknown) => netboxClient.create(endpoints.rackGroups, body, rackGroupCreateSchema, rackGroupSchema),
...
export const rackRolesApi = {
  ...
  create: (body: unknown) => netboxClient.create(endpoints.rackRoles, body, rackRoleCreateSchema, rackRoleSchema),
